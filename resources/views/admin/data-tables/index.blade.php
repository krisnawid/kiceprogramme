...
<head>
  ...
  <title>Student Exchange - Data Registration User</title>
      ...
      <li class="nav-item active">
        ...
        <div id="collapseTable" class="collapse show" aria-labelledby="headingTable" data-parent="#accordionSidebar">
          <div class="bg-white py-2 collapse-inner rounded">
            ...
            <a class="collapse-item active" href="simple-tables.html">Data Registration User</a>
              ...
              <div class="dropdown-list dropdown-menu dropdown-menu-right shadow animated--grow-in"
                ...
                <a class="dropdown-item d-flex align-items-center" href="#">
                  <div class="dropdown-list-image mr-3">
                    <img class="rounded-circle" src="{{ asset('img/admin/man.png') }}" style="max-width: 60px" alt="">
                ...
                <a class="dropdown-item d-flex align-items-center" href="#">
                  <div class="dropdown-list-image mr-3">
                    <img class="rounded-circle" src="{{ asset('img/admin/girl.png') }}" style="max-width: 60px" alt="">
